...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_toaster_service_service__ = __webpack_require__(222);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_toaster_service_service__ = __webpack_require__(222);
...
var LoginComponent = (function () {
    function LoginComponent(flashMessage, authService, router, toasterService) {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessage.show("Welcome " + data.user.name, { cssClass: 'alert-success', timeout: 5000 });
...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getProfile().subscribe(function (profile) {
            ...
            _this.flashMessage.show(JSON.stringify(err._body), { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_router__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_toaster_service_service__ = __webpack_require__(222);
...
var RegisterComponent = (function () {
    function RegisterComponent(validateService, flashMessage, authService, router, toasterService) {
    ...
    RegisterComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5__services_toaster_service_service__["a" /* ToasterService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__services_toaster_service_service__["a" /* ToasterService */]) === 'function' && _e) || Object])
    ], RegisterComponent);
